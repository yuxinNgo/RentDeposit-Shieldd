...
3. Added analytics and transaction activity proof docs.
4. Added Level 5 screenshots for analytics, submission and feedback pages.
5. Exposed the feedback route to the landlord role so reviewers can open the proof page without switching roles.
